...
error_reporting(0);//The error_reporting() function specifies which errors are reported.
    ...
    <head>  
      <!--  <meta charset="utf-8">
       ...
       <link rel="stylesheet" href="../plugins/morris/morris.css">
        ...
        <link href="assets/css/components.css" rel="stylesheet" type="text/css" /><!--give to menu in left side-->
       <link href="assets/css/icons.css" rel="stylesheet" type="text/css" /><!--use to give icon in div-->
